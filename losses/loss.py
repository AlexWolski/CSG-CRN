...
class Loss(nn.Module):
	...
	def forward(self, target_sdf, initial_sdf, refined_sdf, shape_dist, operation_dist):
		...
		primitive_loss = primitive_weight * self.primitive_loss(refined_sdf)
		shape_reg_loss = shape_weight * self.entropy_loss_1(shape_dist)
		operation_reg_loss = operation_weight * self.entropy_loss_2(operation_dist)
...
if __name__ == "__main__":
	...
	print('Total Loss:')
	print(loss.forward(target_sdf, initial_sdf, refined_sdf, shape_dist, operation_dist))