...
def get_model_parser():
	...
	model_group.add_argument('--loss_sampling_method', type=str.upper, default=[Loss.TARGET_SAMPLING], choices=Loss.loss_sampling_methods, nargs=1, help="TARGET_SAMPLING samples loss points from only the target shape and UNIFIED_SAMPLING samples from both target and reconstruction shapes.")
